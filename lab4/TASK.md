...
репозитории:
- `schema_design.md` - описание проектирования документной модели с обоснованием
выбора embedded/references
...
- `README.md` - описание проекта, инструкции по запуску MongoDB и выполнению
запросов
- Dockerfile и docker-compose.yml для запуска API и MongoDB (расширьте предыдущую
работу)
Критерии оценки:
